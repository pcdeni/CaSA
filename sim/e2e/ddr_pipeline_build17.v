...
module ddr_pipeline(
  ...
  output [3:0]                  ddr_read,
  // build17: origin of the read commands leaving on ddr_read this cycle
  input                         ddr_maint,
  ...
  // build17: one register, in lockstep with ddr_read_r
  reg                         ddr_maint_r;
  always @(posedge clk) ddr_maint_r <= ddr_maint;
  assign ddr_read_maint = ddr_maint_r;
