...
module decode_stage(
  ...
  // build17: origin travelling with this uop
  input                         instr_maint,
  output                        ddr_maint,
  ...
  // build17: one register, in lockstep with ddr_valid_r / ddr_uop_r
  reg ddr_maint_r;
  always @(posedge clk) ddr_maint_r <= instr_maint;
  assign ddr_maint = ddr_maint_r;
