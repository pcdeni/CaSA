...
module softmc_core #(parameter tCK = 1500, SIM = "false")
  (
  // common signals
  input c0_sys_clk_p,
  input c0_sys_clk_n,
  ...
  wire                        rbe_set_read;   // build4: idempotent SET READ_MODE word
  wire                        rbe_set_diff;   // build4: idempotent SET DIFF_MODE word
  wire                        rbe_set_segpop; // build7: idempotent SET SEG_POP word
  wire                        rbe_set_accxbp; // build8
  wire                        rbe_set_accw;   // build8
  wire [3:0]                  rbe_accw_pl;    // build8
  wire                        rbe_flush_acc;  // build8
  wire                        toggle_dll;
  ...
  frontend #(.SIM_MEM(SIM)) frontend(
    ...
    .rbe_set_read(rbe_set_read),   // build4
    .rbe_set_diff(rbe_set_diff),   // build4
    .rbe_set_segpop(rbe_set_segpop), // build7
    .rbe_set_accxbp(rbe_set_accxbp), // build8
  ...
  .set_mode_read(rbe_set_read),   // build4: idempotent SET words
  .set_mode_diff(rbe_set_diff),
  .set_mode_segpop(rbe_set_segpop), // build7
  .set_mode_accxbp(rbe_set_accxbp), // build8
